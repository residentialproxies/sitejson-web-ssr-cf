...
export const FEATURED_REPORTS: FeaturedReport[] = [
  {
    domain: 'openai.com',
    title: 'AI category leader',
    description: 'Explore how a breakout AI product scores across trust, traffic volume, SEO structure, and technology signals.',
    href: '/data/openai.com',
    vertical: 'AI Software',
    bestFor: 'Benchmarking authority signals and brand credibility in a high-growth category.',
    signals: ['Trust score and legitimacy posture', 'Traffic scale and rank context', 'Technology stack breakdown'],
  },
  {
    domain: 'stripe.com',
    title: 'B2B infrastructure benchmark',
    description: 'Inspect how a mature fintech platform builds brand authority, SEO depth, and infrastructure footprint.',
    href: '/data/stripe.com',
    vertical: 'Fintech Infrastructure',
    bestFor: 'Understanding how established platform businesses signal credibility at scale.',
    signals: ['SEO structure and maturity', 'Business classification and monetization', 'Infrastructure and provider depth'],
  },
  {
    domain: 'figma.com',
    title: 'Design SaaS analysis',
    description: 'See how a category-defining SaaS product reads across traffic, trust, and audience positioning modules.',
    href: '/data/figma.com',
    vertical: 'Design SaaS',
    bestFor: 'Evaluating category fit, product positioning, and audience profile for a recognized brand.',
    signals: ['Category and taxonomy classification', 'Trust and sentiment review', 'Traffic scale and engagement'],
  },
  {
    domain: 'vercel.com',
    title: 'Developer platform deep-dive',
    description: 'Analyze stack composition, traffic quality, and business posture on a developer-first platform.',
    href: '/data/vercel.com',
    vertical: 'Developer Tools',
    bestFor: 'Benchmarking technical maturity and ecosystem credibility in developer infrastructure.',
    signals: ['Full tech stack and CDN providers', 'Traffic quality and rank signals', 'Alternatives and adjacent players'],
  },
];

export const RESEARCH_SIGNAL_CARDS: ResearchSignalCard[] = [
  {
    title: 'Directory-led discovery',
    value: '3 browse hubs',
    description: 'Start from category, technology, or topic hubs to map a market before drilling into any single domain.',
  },
  {
    title: 'Deep, structured reports',
    value: '6 report modules',
    description: 'Traffic, SEO, tech stack, business context, trust score, and alternatives — all connected in one research flow.',
  },
  {
    title: 'Connected navigation paths',
    value: 'No dead ends',
    description: 'Every hub, report, and alternatives page links forward. Visitors stay in research mode instead of bouncing.',
  },
  {
    title: 'Earn trust before signup',
    value: 'API optional',
    description: 'The full site experience proves the data model. API access is the natural next step, not the gate.',
  },
];
...
export const USE_CASE_CARDS: UseCaseCard[] = [
  {
    ...
    description: 'Start in a directory hub, scan the top players, open live reports, and compare traffic, SEO, and trust signals — without building a spreadsheet first.',
    cta: 'Browse directory hubs',
    href: '/directory',
  },
  {
    title: 'Qualify leads before outreach',
    description: 'Pull any prospect domain to check traffic scale, technology stack, business category, and trust score. Filter weak leads before you invest time on them.',
    cta: 'See a live example',
    href: '/data/openai.com',
  },
  {
    title: 'Automate at scale with the API',
    description: 'Once the manual workflow proves its value, step into signed API access and start enriching your CRM, dashboard, or data pipeline with structured site intelligence.',
...
export const HOME_FAQS: FaqEntry[] = [
  {
    ...
    answer: 'Quite a lot. Browse category, technology, and topic directory hubs. Open live domain reports for any website. Compare trust and traffic signals side by side. Use the full site as a research workflow — the API is entirely optional until you need to automate.',
  },
  {
    question: 'How is a SiteJSON report different from a basic domain lookup?',
    answer: 'A basic lookup gives you one metric. A SiteJSON report organizes SEO structure, traffic estimates, technology detection, business classification, trust scoring, and alternative sites into a connected workflow — so you always know what to look at next and why it matters.',
  },
  {
    question: 'Who is SiteJSON built for?',
    answer: 'Growth teams qualifying leads, SEO practitioners benchmarking competitors, sales operators researching prospects, security teams screening risky domains, and developers building enrichment pipelines. The experience is designed to be useful before you ever touch the API.',
  },
  {
    question: 'Why are the directory hubs valuable for research?',
    answer: 'They give you a market-level starting point instead of forcing you to know a domain name upfront. Browse by industry category, technology stack, or editorial topic — then branch into live reports for the specific sites that look most relevant.',
  },
];
